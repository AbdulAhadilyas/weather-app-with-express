...
const TempApp = () => {
  ...
  const getWeather = (e) => {
    ...
    axios.get(`https://rich-red-jellyfish-boot.cyclic.app/weather/${city}`)
                ...
                <div className="info-side">
                  ...
                  <div className="week-container">
                    <ul className="week-list">
                      ...
                      <li><i className="day-icon" data-feather="cloud" /><span className="day-name"></span><span className="day-temp">  {Math.round(weatherData.forecast.forecastday[0].day.avgtemp_c)
                      }°C </span></li>
                      <li><i className="day-icon" data-feather="cloud-snow" /><span className="day-name"></span><span className="day-temp">{Math.round(weatherData.forecast.forecastday[1].day.avgtemp_c)
                      }°C</span></li>
                      <li><i className="day-icon" data-feather="cloud-rain" /><span className="day-name">°C</span></li>

                     <li><i className="day-icon" data-feather="cloud-rain" /><span className="day-name"></span><span className="day-temp">°C</span></li>
